                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        ...
                        <div class="banner-buttons">
                            <a class="border-button" href="/explore" type="button">Explore Top NFTs</a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="item">
                                                            ...
                                                            <div class="down-content">
                                                                ...
                                                                <div class="banner-buttons">
                                                                    <a class="main-button" href="/explore">Explore Bored Ape</a>
                                                                 </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="item">
                                                            ...
                                                            <div class="down-content">
                                                                ...
                                                                <div class="banner-buttons">
                                                                    <a class="main-button" href="/explore">Explore Genesis</a>
                                                                 </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="item">
                                                            ...
                                                            <div class="down-content">
                                                                ...
                                                                <div class="banner-buttons">
                                                                    <a class="main-button" href="/explore">Explore Worldwide</a>
                                                                 </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="item">
                                                            ...
                                                            <div class="down-content">
                                                                ...
                                                                <div class="banner-buttons">
                                                                    <a class="main-button" href="/explore">Explore Mutant</a>
                                                                 </div>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <section class="creating-nft">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="banner-buttons">
                            <a class="main-button" href="/create">Create Your NFT Now</a>
                        </div>
                    </div>
                    <div class="col-lg-4">
